...
import { Globe, Command, Copy } from 'lucide-react';
...
export default function ModernChatbotSetup() {
  ...
  // Fetch user projects when user data is available
  useEffect(() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <h2 className="text-xl font-medium mb-4 flex items-center">Existing Projects</h2>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors disabled:bg-gray-400 flex items-center justify-center space-x-2"
            >
              {isLoading && (
